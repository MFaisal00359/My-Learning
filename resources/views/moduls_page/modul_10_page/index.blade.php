<x-guest-layout>
    ...
    <section class="relative container mx-auto p-4 sm:py-20 px-0 md:p-10 md:px-0 text-center selection:text-white">
        {{-- SECTION CARDS --}}
        <section class="p-5 text-center grid px-5 grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 place-content-center bg-slate-400 gap-4 ">

            @forelse ($moduls_10 as $modul)
            {{-- CARD MODUL --}}
            <article class="relative w-[300px] shadow-lg cursor-pointer border-solid border-2 bg-white rounded-lg">
